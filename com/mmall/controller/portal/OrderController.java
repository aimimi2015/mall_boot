...
//    private static final Logger logger = LoggerFactory.getLogger(OrderController.class);
    ...
    public ServerResponse pay(HttpServletRequest httpServletRequest, Long orderNo, HttpServletRequest request) {
        ...
        System.out.println("注意,这里就是那个path:  " + path);
    ...
    public Object alipayCallback(HttpServletRequest request) {
        ...
        for (Iterator iter = requestParams.keySet().iterator(); iter.hasNext(); ) {
            ...
            //这里的name是requestParams这个map中的每一个键的名字 比如:sign  trade_status
        ...
        params.remove("sign_type");  //支付宝官方要求移除这个参数
        try {
            boolean alipayRSACheckedV2 = AlipaySignature.rsaCheckV2(params, Configs.getAlipayPublicKey(), "utf-8", Configs.getSignType());
                    //这个rsaCheckV2可以帮助实现rsa2加密    另外configs加载了一些配置,我们不用自己去读取了   用Configs.getAlipayPublicKey()
            if (!alipayRSACheckedV2) {
                return ServerResponse.creatByErrorMessage("非法请求,验证不通过,再恶意请求我就报警找网警了");
            }
