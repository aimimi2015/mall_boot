 ...
 */
@JsonInclude(JsonInclude.Include.NON_NULL)//保证序列化json的时候,如果是null的对象,key也会消失  ,比如有事传到前端的数据中,不需要传data,data的值为空就不会被传过去
public class ServerResponse<T> implements Serializable {
    ...
    //因为是public所以如果json序列化的时候也会和status;msg;data;一起显示到前端.使之不在json序列化中
